  ...
  return (
    <div className="flex flex-col bg-[#FCFCFD] text-[#344054] px-4 md:px-20 py-10 gap-12">
      ...
      <div className="flex flex-col md:flex-row justify-between">
        ...
        <div className="grid grid-cols-2 md:flex gap-y-8 md:gap-8 text-wrap pb-8 break-words">
          <div className="flex flex-col gap-2 max-w-[170px]">
              <span className="text-xl font-bold">La empresa</span>
              <p className="text-sm">Quienes somos</p>
              <p className="text-sm">Misión, Visión e Historia</p>
              <p className="text-sm">Ética</p>
              <p className="text-sm">Nuestras sucursales</p>
          </div>
          <div className="flex flex-col gap-2 max-w-[170px]">
              <span className="text-xl font-bold">Información</span>
              <p className="text-sm">Aviso de Privacidad</p>
              <p className="text-sm">Habeas Data</p>
              <p className="text-sm">Términos y Condiciones de promociones</p>
          </div>
          <div className="flex flex-col gap-2 max-w-[170px]">
              <span className="text-xl font-bold">Club Vida Sana</span>
              <p className="text-sm">Beneficios del Club</p>
              <p className="text-sm">Actualiza tus datos</p>
          </div>
          <div className="flex flex-col gap-2 max-w-[170px]">
              <span className="text-xl font-bold">Contacto</span>
              <p className="text-sm">315 782 3477</p>
              <p className="text-sm">Radicar PQRS</p>
              <p className="text-sm">servicioalcliente<br/>@droguerialaeconomia.com</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex border-[2px] px-8 py-4 border-[#D0D5DD] justify-center items-center rounded-2xl gap-8">
              ...
              <span className="flex md:hidden text-xl font-bold" >!Descarga gratis la App!</span>
            </div>
          </div>
          <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between text-base gap-6 md:gap-0">
        <p className="text-wrap">©2023 Droguería La Economía. Todos los derechos reservados. v5.0 - <a href="/politicas" className="underline">Politicas de privacidad</a></p>
